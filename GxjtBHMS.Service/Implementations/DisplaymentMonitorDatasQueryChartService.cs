...
{
    public class DisplaymentMonitorDatasQueryChartService : IMonitorDatasEigenvalueQueryChartService<DisplacementTable>
    {
        readonly IDisplaymentDatasDAL _displaymentDatasDAL;
        public DisplaymentMonitorDatasQueryChartService(IDisplaymentDatasDAL displaymentDatasDAL)
        {
            _displaymentDatasDAL = displaymentDatasDAL;
        }

        public IEnumerable<ChartGroupDataModel> GetChartDataSourceBy(IList<Func<DisplacementTable, bool>> ps)
        {
