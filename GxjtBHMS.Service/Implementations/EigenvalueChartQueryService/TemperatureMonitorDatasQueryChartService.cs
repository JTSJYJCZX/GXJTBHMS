...
{
    public class TemperatureMonitorDatasQueryChartService : IMonitorDatasEigenvalueQueryChartService<TemperatureEigenvalueTable>
    {
        readonly ITemperatureDatasEigenvalueDAL _temperatureDatasDAL;
        public TemperatureMonitorDatasQueryChartService(ITemperatureDatasEigenvalueDAL temperatureDatasDAL)
        {
            _temperatureDatasDAL = temperatureDatasDAL;
        }

        public IEnumerable<ChartGroupDataModel> GetChartDataSourceBy(IList<Func<TemperatureEigenvalueTable, bool>> ps)
        {
        ...
        public long GetTotalResultCountBy(IList<Func<TemperatureEigenvalueTable, bool>> ps)
        {
