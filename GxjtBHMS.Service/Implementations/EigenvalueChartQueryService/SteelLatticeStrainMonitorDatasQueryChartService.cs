...
namespace GxjtBHMS.Service.Implementations
{
    class SteelLatticeStrainMonitorDatasQueryChartService : IMonitorDatasEigenvalueQueryChartService<SteelLatticeStrainEigenvalueTable>
    {
        ...
        public long GetTotalResultCountBy(IList<Func<SteelLatticeStrainEigenvalueTable, bool>> ps)
        {
            return _strainDatasDAL.GetCountByContains(ps, ServiceConstant.PointsNumberPointsPositionNavigationProperty);
        }
    }
}
