...
{
    class SteelArchStrainMonitorDatasQueryFileSystemService : IMonitorDatasQueryFileSystemService<SteelArchStrainEigenvalueTable>
    {
        ...
        public object ConvertToDocument(IList<Func<SteelArchStrainEigenvalueTable, bool>> ps)
        {
            ...
            ISheet sheet = workbook.CreateSheet("钢拱肋应变特征值查询结果");
