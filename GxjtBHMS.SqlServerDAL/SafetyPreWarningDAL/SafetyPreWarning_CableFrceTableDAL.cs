...
namespace GxjtBHMS.SqlServerDAL.SafetyPreWarningDAL
{
    ...
    public class SafetyPreWarning_CableFrceTableDAL : Repository<SafetyPreWarning_CableFrceTable, int>, ISafetyPreWarningDetailDAL<SafetyPreWarning_CableFrceTable>
    {
