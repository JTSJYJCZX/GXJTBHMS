...
{
    public class MonitoringDatasEigenvalueDownloadDAL: IMonitoringDatasEigenvalueDownloadDAL
    {
        public string DownLoadTxtByExec(ConditionParameters ps, string path, string ProcName)
        {
            string returnPath = string.Empty;
            string connectionString = ConfigurationManager.ConnectionStrings[ApplicationSettingsFactory.GetApplicationSettings().DBConnectionName].ConnectionString;
            string sql = ProcName;//要调用的存储过程名
