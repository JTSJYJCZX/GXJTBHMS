...
namespace GxjtBHMS.Web.ViewModels.Home
{
    public class SafetyAssessmentModelsViewModel
    {
        ...
        public string ManualInspectionSafetyAssessmentReportTime { get; set; }//人工巡检评估时间
        public string FirstSafetyAssessmentReportTime { get; set; }//一级安全评估时间
        public string SecondSafetyAssessmentReportTime { get; set; }//二级安全评估时间
    }
}
