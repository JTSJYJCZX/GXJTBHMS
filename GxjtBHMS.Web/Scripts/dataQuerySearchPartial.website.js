...
$(function () {
    ...
    $("#mornitorTestTypeSelect").change(function () {
        ...
        $.ajax({
            url: "/MonitoringDatas/GetMonitoringPointsPositionsByTestTypeId?testTypeId=" + testTypeId,//URL请求命令
            type: "get",
            dataType: "json",
    ...
    function monitorTestPointsPositionSelectChange() {
        ...
        $.ajax({
            url: "/MonitoringDatas/GetMonitoringPointsNumbersByPointsPositions?pointsPositions=" + pointsPosition,//URL请求命令
            type: "get",
            dataType: "json",
            contentType: "application/json",
            success: function (datas) {
